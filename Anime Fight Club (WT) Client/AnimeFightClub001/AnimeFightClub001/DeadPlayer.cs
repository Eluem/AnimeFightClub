...
namespace AnimeFightClub001
{
    class DeadPlayer : SpecialEnvironmentalObj
    {
        ...
        public override void NetInitialize(NetIncomingMessage msg)
        {
            ...
            m_deathAnimation = msg.ReadString();
            if (!GlobalVariables.ImageDict.ContainsKey(m_deathAnimation))
            {
                m_deathAnimation = "NaniDeath";
            }
            m_drawableObj = new Sprite(m_deathAnimation, Color.Wheat, this, GlobalVariables.GetLayer(ObjectLayer.SpecialEnvironmental));
            m_deathTimer = msg.ReadInt32();
        }
