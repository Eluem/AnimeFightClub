//******************************************************
// File: AbilityPoisonSpikeTrap.cs
//
// Purpose: Defines AbilityPoisonSpikeTrap.
//
...
{
    class AbilityPoisonSpikeTrap : Ability
    {
        //****************************************************
        // Method: AbilityPoisonSpikeTrap
        //
        // Purpose: Default constructor for AbilityPoisonSpikeTrap
        //****************************************************
        public AbilityPoisonSpikeTrap() :
            base(null, 0, 0, 0, 0)
        {
        ...
        {
            if (m_pressedDuration == 0 && m_ownerObj.MP >= 6000)
            {
        ...
        {
            HazardPoisonSpikeTrap added = new HazardPoisonSpikeTrap(550, m_ownerObj.ObjectID, "Player");
