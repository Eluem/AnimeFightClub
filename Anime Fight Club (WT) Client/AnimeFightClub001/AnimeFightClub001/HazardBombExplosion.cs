...
namespace AnimeFightClub001
{
    class HazardBombExplosion : HazardObj
    {
            ...
            : base()
        {
            ...
            m_drawableObj = new Sprite("NukeExplosion", Color.Wheat, this, GlobalVariables.GetLayer(ObjectLayer.Hazard));
            m_drawableObj.SetDimensions(200, 250);
            GlobalVariables.PlaySound("Explosion Sound 001");
        }
