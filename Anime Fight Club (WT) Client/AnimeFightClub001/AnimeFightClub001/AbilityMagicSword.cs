//******************************************************
// File: AbilityMagicSword.cs
//
// Purpose: Defines AbilityMagicSword.
//
...
{
    class AbilityMagicSword : Ability
    {
        #region Declarations
        ...
        //*********************************************************
        // Method: AbilityMagicSword
        //
        // Purpose: Default constructor for AbilityMagicSword
        //*********************************************************
        public AbilityMagicSword() :
            base(null, 0, 0, 0, 0, "AbilityMagicSword")
        {
        ...
        public override void ReleasedHook()
        {
            switch (m_attackChoice)
            {
                ...
                case AbilitySwordAttackChoice.DefaultSlash:
                    //Charged slash
                    if (m_pressedDuration > 800)
                    {
                        GlobalVariables.PlaySound("EnergyBlade");
                    ...
                    {
                        GlobalVariables.PlaySound("Sword Swing");
        ...
        public override void UpdateHook(GameTime gameTime)
        {
            ...
            if (m_pressedDuration > 800 && m_attackChoice != AbilitySwordAttackChoice.None)
            {
                m_state = (int)AbilitySwordStateEnum.SlashingHoldUpCharged;
            }

            if (m_pressedDuration > 1300 && m_state == (int)AbilitySwordStateEnum.SlashingHoldUpCharged && m_ownerObj.PhysicsObj.Sided[Side.bottom]) 
            {
                Interrupt();
            }
            ...
            if (!m_abilityFired)
            {
                ...
                switch (m_attackChoice)
                {
                    ...
                    case AbilitySwordAttackChoice.DefaultSlash:
                        ...
                        {
                            HazardMagicSwordSlash added = new HazardMagicSwordSlash(500, m_ownerObj.ObjectID, "Player");
                    ...
                    case AbilitySwordAttackChoice.StrongSlash:
                        ...
                        {
                            HazardEnergyBlade added = new HazardEnergyBlade(900, m_ownerObj.ObjectID, "Player");
                            GameObjectHandler.AddObject(added);
                            m_abilityFired = true;
                        }
                        break;
