...
namespace AnimeFightClub001
{
    static class GameObjectHandler
    {
        ...
        static public void Update(GameTime gameTime, Viewport viewport)
        {
            ...
            NetworkingHandler.ApplyVectListBuffers();
        ...
        // and empties all the lists.
        //****************************************************
        static public void Reset()
        {
            //Lists that store all the different types of objects in the game
            m_playerObjList.Clear();
        ...
        #region DirectDeleteObjectByID Functions
        //********************************************************
        // Method: DirectDeletePlayerObjectByID
        //
        // Purpose: Overload of DirectDeleteObject which directly
        // deletes the player from the m_playerObjList by ID
        //********************************************************
        static public void DirectDeletePlayerObjectByID(UInt16 id)
        {
            PlayerObj player = null;
            foreach (PlayerObj i in m_playerObjList)
            {
                if (i.ObjectID == id)
                {
                    player = i;
        ...
        //********************************************************
        // Method: DirectDeleteHazardObjectByID
        //
        // Purpose: Overload of DirectDeleteObject which directly
        // deletes the hazard from the m_hazardObjList by ID
        //********************************************************
        static public void DirectDeleteHazardObjectByID(UInt16 id)
        {
            HazardObj hazard = null;
            foreach (HazardObj i in m_hazardObjList)
            {
                if (i.ObjectID == id)
                {
                    hazard = i;
        ...
        //********************************************************
        // Method: DirectDeleteEnvironmentalObjectByID
        //
        // Purpose: Overload of DirectDeleteObject which directly
        // deletes the environmentalObj from
        // the m_environmentalObjList by ID
        //********************************************************
        static public void DirectDeleteEnvironmentalObjectByID(UInt16 id)
        {
            EnvironmentalObj environmentalObj = null;
            foreach (EnvironmentalObj i in m_environmentalObjList)
            {
                if (i.ObjectID == id)
                {
                    environmentalObj = i;
        ...
        //********************************************************
        // Method: DirectDeleteSpecialEnvironmentalObjectByID
        //
        // Purpose: Overload of DirectDeleteObject which directly
        // deletes the specialEnvironmentalObj from
        // the m_specialEnvironmentalObjList by ID
        //********************************************************
        static public void DirectDeleteSpecialEnvironmentalObjectByID(UInt16 id)
        {
            SpecialEnvironmentalObj specialEnvironmentalObj = null;
            foreach (SpecialEnvironmentalObj i in m_specialEnvironmentalObjList)
            {
                if (i.ObjectID == id)
                {
                    specialEnvironmentalObj = i;
                    break;
                }
            }
            if (specialEnvironmentalObj == null)
            {
                return;
            }
            m_specialEnvironmentalObjList.Remove(specialEnvironmentalObj);
        ...
        //********************************************************
        // Method: DirectDeleteItemObjectByID
        //
        // Purpose: Overload of DirectDeleteObject which directly
        // deletes the item from the m_itemObjList by ID
        //********************************************************
        static public void DirectDeleteItemObjectByID(UInt16 id)
        {
            ItemObj item = null;
            foreach (ItemObj i in m_itemObjList)
            {
                if (i.ObjectID == id)
                {
                    item = i;
        ...
        //********************************************************
        // Method: DirectDeleteBasicObjectByID
        //
        // Purpose: Overload of DirectDeleteObject which directly
        // deletes the basicObj from the m_basicObjList by ID
        // (Unlikely to use)
        //********************************************************
        static public void DirectDeleteBasicObjectByID(UInt16 id)
        {
            BasicObj basicObj = null;
            foreach (BasicObj i in m_basicObjList)
            {
                if (i.ObjectID == id)
                {
                    basicObj = i;
